...
namespace GoogleARCore.Examples.AugmentedImage
{
    ...
    public class AugmentedImageVisualizer : MonoBehaviour
    {
       ...
       // public GameObject FrameUpperLeft;
        ...
        public void Start()
        {
            MyParent = GameObject.Find("BookCamera");
            BookObject = GameObject.Find("ImageScanPos");
        }
        ...
        public void Update()
        {
           ...
           float halfHeight = Image.ExtentZ / 2;
            prefabs[Image.DatabaseIndex].transform.parent = MyParent.transform;
            // prefabs[Image.DatabaseIndex].transform.localPosition = new Vector3(-1f, -1f, -1f);
            prefabs[Image.DatabaseIndex].transform.position =new Vector3(BookObject.transform.position.x, BookObject.transform.position.y, BookObject.transform.position.z+0.1f);
